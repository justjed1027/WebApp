...
<body class="has-side-content" data-logo-path="<?php echo htmlspecialchars($logoPath, ENT_QUOTES, 'UTF-8'); ?>">
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <div class="sidebar-middle">
      <div class="nav-group">
        <a href="../dashboard2/dashboard2.php" class="nav-link active" data-tooltip="Dashboard">
    ...
    <div class="sidebar-bottom">
      ...
      <a href="course-list.php?action=logout" class="nav-link" data-tooltip="Log Out">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
    ...
    <div class="page-content">
      <div class="course-list-content">
        ...
        <div class="breadcrumb">
          ...
          <span class="breadcrumb-current"><?php echo htmlspecialchars($group['name']); ?></span>
        </div>
