...
<body class="has-side-content">
  ...
  <!-- Sidebar Navigation (matches calendar layout) -->
  ...
  <!-- Top Bar Navigation (matches calendar layout) -->
  <header class="topbar">
  ...
  <main class="main-content connections-page">
    <div class="main-left">
          ...
          <div class="suggested-list">
            <?php while ($row = $recommended->fetch_assoc()): ?>
              <div class="suggested-item">
                ...
                <div class="conn-info">
                  <div class="conn-name"><?php echo htmlspecialchars($row['user_username']); ?></div>
                  <div class="conn-role">Explore similar interests</div>
                </div>
    ...
    <?php renderSideContent('connections', ['hide' => ['notifications']]); ?>
  </main>
