...
$conn->query("DELETE FROM bpa_skillswap.user_interests WHERE ui_user_id = $user_id");

// Insert new ones
$stmt = $conn->prepare("INSERT INTO bpa_skillswap.user_interests (ui_user_id, ui_subject_id) VALUES (?, ?)");
