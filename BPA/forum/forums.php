...
$userPreferences = UserPreferences::getForUser($con, (int)($_SESSION['user_id'] ?? 0));
...
<body class="has-side-content" data-logo-path="<?php echo htmlspecialchars($logoPath, ENT_QUOTES, 'UTF-8'); ?>">
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <div class="sidebar-bottom">
      ...
      <a href="forums.php?action=logout" class="nav-link" data-tooltip="Log Out">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
  ...
  <main class="main-content">
    <div class="page-content">
      <!-- Forum Content (unique to this page) -->
      <div class="forum-container">
        <!-- Page Header -->
        <div class="forum-header-card">
          <div class="page-header-content">
            <h1 class="page-main-title">Community Forums</h1>
            <p class="page-subtitle">Connect, discuss, and share knowledge with fellow learners</p>
          </div>
        </div>
        ...
        <div class="forum-main">
          ...
          <div class="forum-topbar">
            <div class="search-wrapper">
              ...
              <input type="text" class="forum-search" placeholder="Search topics, categories, and users...">
            </div>
          ...
          <div class="forum-card">
            <div class="card-header">
              ...
              <span class="category-count">5 Categories</span>
            </div>
            <div class="forum-categories">
            <div class="forum-categories">
              <a href="forum-math.html" class="forum-category-link">
                ...
                <div class="category-content">
                  <div class="forum-category-title">Academic Subjects</div>
                  <div class="forum-category-desc">Discussions related to specific academic fields like Math, Science, English, and more</div>
                </div>
              ...
              <a href="forum-general.html" class="forum-category-link">
                <div class="category-icon-wrapper">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 16 16">
                    <path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2zm5.5 10a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 0-1H6a.5.5 0 0 0-.5.5M5 5a1 1 0 0 0 0 2h6a1 1 0 1 0 0-2z" />
                  </svg>
                </div>
                <div class="category-content">
                  <div class="forum-category-title">Programming & Development</div>
                  <div class="forum-category-desc">Coding questions, projects, debugging help, and software development resources</div>
                </div>
                <div class="forum-category-meta">
                  <div class="meta-stat">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
              ...
              <a href="forum-english.html" class="forum-category-link">
                <div class="category-icon-wrapper">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 16 16">
                ...
                <div class="category-content">
                  <div class="forum-category-title">Study Tips & Techniques</div>
                  <div class="forum-category-desc">Share effective learning strategies, time management, and study methods</div>
                </div>
                <div class="forum-category-meta">
                  <div class="meta-stat">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
              ...
              <a href="forum-science.html" class="forum-category-link">
                <div class="category-icon-wrapper">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 16 16">
                ...
                <div class="category-content">
                  <div class="forum-category-title">Career & Professional Development</div>
                  <div class="forum-category-desc">Internships, job opportunities, resume tips, and career advice</div>
                </div>
                <div class="forum-category-meta">
                  <div class="meta-stat">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
              ...
              <a href="forum-general.html" class="forum-category-link">
                ...
                <div class="category-content">
                  <div class="forum-category-title">Campus Life</div>
                  <div class="forum-category-desc">Events, activities, clubs, and general campus-related discussions</div>
                </div>
                <div class="forum-category-meta">
                  <div class="meta-stat">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
            ...
            <table class="forum-topics-table">
              ...
              <tbody>
                <tr>
                  <td>
                    <div class="topic-content">
                      <a href="#" class="topic-link">Tips for mastering data structures and algorithms</a>
                      <span class="topic-by">Started by <strong>Alex Johnson</strong></span>
                    </div>
                  </td>
                  <td><span class="category-badge programming">Programming & Dev</span></td>
                ...
                <tr>
                  <td>
                    <div class="topic-content">
                      <a href="#" class="topic-link">How to prepare for finals in just two weeks</a>
                      <span class="topic-by">Started by <strong>Morgan Lee</strong></span>
                    </div>
                  </td>
                  <td><span class="category-badge study">Study Tips</span></td>
                ...
                <tr>
                  <td>
                    <div class="topic-content">
                      <a href="#" class="topic-link">Looking for study group partners for Calculus II</a>
                      <span class="topic-by">Started by <strong>Taylor Wilson</strong></span>
                    </div>
                  </td>
                ...
                <tr>
                  <td>
                    <div class="topic-content">
                      <a href="#" class="topic-link">Summer internship opportunities in tech</a>
                      <span class="topic-by">Started by <strong>Jamie Rivera</strong></span>
                    </div>
                  </td>
                  <td><span class="category-badge career">Career</span></td>
  ...
  <!-- Side Content (reused from existing pages) -->
